...
for restart in range(flags.n_restarts):
    ...
    train_X_list = data_X1.cpu().tolist()+data_X2.cpu().tolist()
    train_Y_list = data_Y1.cpu().tolist()+data_Y2.cpu().tolist()

    indices = [i for i in range(len(train_X_list))]
    ...
    for i in indices:
        train_X.append(train_X_list[i])
        train_Y.append(train_Y_list[i])
