...
for restart in range(flags.n_restarts):
    ...
    def penalty_fn(logits_1, y_1, logits_2, y_2):
        ...
        grad1 = autograd.grad(loss_1.mean(), [scale], create_graph=True)[0]
        grad2 = autograd.grad(loss_2.mean(), [scale], create_graph=True)[0]

        grad_norm = torch.sum(grad1**2)+torch.sum(grad2**2)
